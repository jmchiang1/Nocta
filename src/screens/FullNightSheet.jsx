/* Nocta — full-night detail. Time-aligned chart stack + expandable episodes list. */
...
export function FullNightSheet() {
  const { fixtureId, closeSheet } = useStore();
    ...
    >
      <div className="fn-summary">
        <div className="fn-stat">
          ...
          <div className="fs-v">{fx.ahi.value != null ? fx.ahi.value.toFixed(1) : '—'}</div>
        </div>
        <div className="fn-stat">
      ...
      <div className="connect-cta">
        <p>Connect a watch or ring and Nocta can line your sleep stages up against your events.</p>
      ...
      <p className="disclaimer">
        Charts show what your machine recorded. Tap any episode to see the breath trace.
      </p>
    </Sheet>
  );
}
